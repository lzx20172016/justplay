...
int transformwin(char *tempbuf)
{
    ...
    strcat(temp,tempbuf);
    char *ptr;
    if((ptr=strstr(temp,".c"))||(ptr=strstr(temp,".cpp"))||(ptr=strstr(temp,".h"))||(ptr=strstr(temp,".hpp")))
    {
        *(ptr+1)='t';
        *(ptr+2)='x';
        *(ptr+3)='t';
...
int main(int argc,char *argv[])
{
    ...
    for(i=1;i<argc;i++)
    {
        if((strstr(argv[i],".c")==NULL)&&(strstr(argv[i],".cpp")==NULL)&&(strstr(argv[i],".h")==NULL)&&(strstr(argv[i],".hpp")))
        {
            printf("[.c]||[.cpp]||[.h]||[.hpp]");
            return -1;
        }
